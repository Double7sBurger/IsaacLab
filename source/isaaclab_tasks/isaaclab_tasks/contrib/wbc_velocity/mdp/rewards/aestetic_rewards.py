...
if TYPE_CHECKING:
    from isaaclab_tasks.contrib.wbc_velocity.mdp.commands.height_command import SmoothHeightCommand
...
from isaaclab_tasks.contrib.wbc_velocity.mdp.utils import (
...
from isaaclab_tasks.contrib.wbc_velocity.utils import math_utils as agile_math_utils
