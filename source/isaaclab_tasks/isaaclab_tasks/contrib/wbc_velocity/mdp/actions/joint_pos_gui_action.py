...
from isaaclab_tasks.contrib.wbc_velocity.mdp.symmetry.symmetry_g1 import lr_mirror_G1
from isaaclab_tasks.contrib.wbc_velocity.mdp.symmetry.symmetry_t1 import lr_mirror_T1
