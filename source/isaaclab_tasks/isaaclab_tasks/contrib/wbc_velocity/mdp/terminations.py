...
from isaaclab_tasks.contrib.wbc_velocity.mdp.utils import get_robot_cfg
...
def bad_motion_body_pos(
    ...
    from isaaclab_tasks.contrib.wbc_velocity.mdp.commands.motion_tracking_commands import MotionCommand
    from isaaclab_tasks.contrib.wbc_velocity.mdp.rewards.motion_tracking_rewards import _get_body_indices
