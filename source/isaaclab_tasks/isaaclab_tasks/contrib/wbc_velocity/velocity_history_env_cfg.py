...
from isaaclab_tasks.contrib.wbc_velocity.mdp.terrains import LESS_ROUGH_TERRAIN_CFG, MEDIUM_ROUGH_TERRAIN_CFG  # noqa: F401

# Define controlled joints for G1 (legs + waist roll/pitch for locomotion)
CONTROLLED_JOINT_NAMES = unitree_g1.LEG_JOINT_NAMES + ["waist_roll_joint", "waist_pitch_joint"]
...
class ActionsCfg:
    ...
    random_pos = mdp.RandomActionCfg(
        asset_name="robot",
        joint_names_exclude=unitree_g1.LEG_JOINT_NAMES + unitree_g1.WAIST_JOINT_NAMES,
...
class RewardsCfg:
    ...
    orientation = RewTerm(
        ...
        weight=5.0,
        params={"std": math.radians(10.0), "asset_cfg": SceneEntityCfg("robot", body_names=["pelvis", "torso_link"])},
    )
    ...
    feet_slip = RewTerm(
        ...
        params={
            ...
            "robot_cfg": SceneEntityCfg("robot", body_names=unitree_g1.FEET_LINK_NAMES),
        },
    )
    ...
    feet_roll = RewTerm(
        ...
        weight=-0.05,
        params={"asset_cfg": SceneEntityCfg("robot", body_names=unitree_g1.FEET_LINK_NAMES)},
    )
...
class TerminationsCfg:
    ...
    illegal_base_height = DoneTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names="pelvis"),
            "sensor_cfg": SceneEntityCfg("height_measurement_sensor"),
            "height_threshold": unitree_g1.DEFAULT_PELVIS_HEIGHT - 0.3,
        },
    )
...
@configclass
class G1LowerVelocityHistoryEnvCfg(ManagerBasedRLEnvCfg):
